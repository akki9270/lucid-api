...
module.exports = function (app) {
    ...
    app.get('/api/getPatientsAnalyticsData/:from/:to', passport.authenticate('jwt', {session: false}), checkValidity, Patients.getPatientsAnalytics);
    app.get('/api/getPatientCallCount/:from/:to', passport.authenticate('jwt', {session: false}), checkValidity, Patients.getPatientCallCount);
    app.get('/api/getPatientMSOC/:entered', passport.authenticate('jwt', {session: false}), checkValidity, Patients.getPatientMSOC);
